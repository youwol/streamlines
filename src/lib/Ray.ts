...
export class Ray {
    ...
    get origin(): vec.Vector3 { return this.orig_ }
    get direction(): vec.Vector3 { return this.dir_ }
    get valid(): boolean { return this.valid_ }

    intersectPlane(p1: vec.Vector3, p2: vec.Vector3, p3: vec.Vector3): {id: number, point: vec.Vector3} {
...
function intersectRay3DPlane(R: Ray, T: Triangle): {flag: number, point: vec.Vector3} {
