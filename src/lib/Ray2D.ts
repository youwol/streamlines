...
export class Ray2D {
    ...
    get origin()    {return this.orig_}
    get direction() {return this.dir_}
    ...
    intersectRay(other: Ray2D, intersection: vec.Vector2, distances: {dist:number, other_dist: number}): boolean {
